...
from aleesa.modules import ALL_MODULES
from aleesa.modules.helper_funcs.alternate import typing_action
from aleesa.modules.helper_funcs.chat_status import is_user_admin
from aleesa.modules.helper_funcs.misc import paginate_modules
from aleesa.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
𝙃𝙚𝙡𝙡𝙤 𝙩𝙝𝙚𝙧𝙚, 𝙄'𝙢 [Aleesa🧚‍♀️](t.me/ankivectorUpdates) 🍑
𝙄'𝙢 𝙖 𝙋𝙤𝙬𝙚𝙧𝙛𝙪𝙡 𝙜𝙧𝙤𝙪𝙥 𝙢𝙖𝙣𝙖𝙜𝙚𝙧 𝙗𝙤𝙩 𝙒𝙞𝙩𝙝 𝘾𝙤𝙤𝙡 𝙈𝙤𝙙𝙪𝙡𝙚𝙨. 𝙈𝙖𝙙𝙚 𝙗𝙮 [TEᗩᗰ Aleesa🧚‍♀️](t.me/TeamAnkiVector)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➕ ᴀᴅᴅ Aleesa🧚‍♀️ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕", url="t.me/aleesa_4kbot?startgroup=true"
        ),
    ],
]


ANKIVECTOR_IMG = "https://telegra.ph/aleesa-09-27"

HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/aleesa-09-27)
